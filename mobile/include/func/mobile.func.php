...
class Mobile
{
	...
	{
		return @include_once(ROOT_PATH . 'mobile/include/func/' .$name.'.func.php');
	}
	...
	function lib($name)
	{
		return @include_once(ROOT_PATH . 'mobile/include/class/lib/' .$name.'.han.php');
	}
