 ...
 *
 * @Date 2013-11-11 2073788025 5377 $
 */
...
class ModuleObject extends MasterObject
{
	...
	function main()
	{
		...
		if (!empty($live_info)) {
			...
			foreach($live_list as $key => $val){				$live_list[$key]['guest'] = array_slice($val['guest'],0,3,true);
			}
		...
		include template('live/live_index');
	}
