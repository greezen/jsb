 ...
 * @version $Id: link.mod.php 3740 2013-05-28 09:38:05Z wuliyong $
 */
...
class ModuleObject extends MasterObject
{
	...
	function Modify()
	{
		...
		$link_list = jconf::get('link');

		include(template('admin/link'));
	}
	...
	function DoModify()
	{
		...
		foreach (@$link as $l)
		{
			...
			$l['url'] = addslashes($l['url']);			$l['order'] = (int) ($l['order'] ? $l['order'] : $key);
