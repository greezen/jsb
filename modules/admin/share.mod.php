 ...
 * @version $Id: share.mod.php 5462 2014-01-18 01:12:59Z wuliyong $
 */
...
class ModuleObject extends MasterObject
{
	...
	function ModuleObject($config)
	{
		...
		$this->ShareConfig = jconf::get('share');
	...
	function Add() {
		...
		include  template('iframe_recommend');
		$content = ob_get_contents();
		ob_clean();

		$web_share_temp =  $content;

		include template('admin/share_info');
	}
	...
	function DoAdd()
	{
		...
		$sets['sharetemp'] = $set;
		jconf::set('sharetemp_'.$shareid,$sets);
	...
	function Modify()
	{
        ...
        if(!$share['livenum']) $share['livenum'] = 2;
		...
		$site_url = '{$this->Config[site_url]}';
				...
				$share_temp = jconf::get('sharetemp_'.$ids);
