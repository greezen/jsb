...
/**
 * 文件名： ucenter.mod.php
 * @version $Id: ucenter.mod.php 3740 2013-05-28 09:38:05Z wuliyong $
 * 作者： 狐狸<foxis@qq.com>
 * 功能描述： 整合Ucenter
 */
...
class ModuleObject extends MasterObject
{
	...
	function Ucenter()
	{
		...
		$uc_enable_radio = $this->jishigou_form->YesNoRadio('ucenter[enable]',(bool) $ucenter['enable']);

		$uc_face_radio = $this->jishigou_form->YesNoRadio('ucenter[face]',(bool) $ucenter['face']);
		${"uc_connect_{$ucenter['uc_connect']}_checked"} = " checked ";

		$uc_modify_nickname_radio = $this->jishigou_form->YesNoRadio('ucenter[modify_nickname]', (bool) $ucenter['modify_nickname']);


		include template('admin/ucenter');
	}
