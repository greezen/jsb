...
/**
 * 文件名：search.mod.php
 * @version $Id: search.mod.php 3740 2013-05-28 09:38:05Z wuliyong $
 * 作者：狐狸<foxis@qq.com>
 * 功能描述: 后台菜单搜索模块
 */
...
class ModuleObject extends MasterObject
{
	...
	function Menu()
	{
		...
		$search_admin_menu_index = jconf::get('search_admin_menu_index');
		$search_admin_menu_click = jconf::get('search_admin_menu_click');
		...
		if(!$search_admin_menu_click || count($search_admin_menu_click) != count($search_admin_menu_index))
		{
			...
			jconf::set('search_admin_menu_click', $search_admin_menu_click);
		}
