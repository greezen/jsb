...
/**
 * 文件名： phpwind.mod.php
 * @version $Id: phpwind.mod.php 3740 2013-05-28 09:38:05Z wuliyong $
 * 作者： 狐狸<foxis@qq.com>
 * 功能描述： 整合phpwind
 */
...
class ModuleObject extends MasterObject
{
	...
	function Main()
	{
		...
		$phpwind = $phpwind_config = jconf::get('phpwind');
		...
		$pw_enable_radio = $this->jishigou_form->YesNoRadio('phpwind[enable]',(bool) $phpwind['enable']);
		$pw_db_charset = $this->jishigou_form->Radio('phpwind[pw_db_charset]',array(array("name"=>"GBK","value"=>"gbk"),array("name"=>"UTF-8","value"=>"utf8")),$phpwind_config['pw_db_charset']);
		$pw_charset = $this->jishigou_form->Radio('phpwind[pw_charset]',array(array("name"=>"GBK","value"=>"gbk"),array("name"=>"UTF-8","value"=>"utf8")),$phpwind_config['pw_charset']);

		$pw_face_radio = $this->jishigou_form->YesNoRadio('phpwind[face]',(bool) $phpwind['face']);
		$pw_bbs_radio = $this->jishigou_form->YesNoRadio('phpwind[bbs]',(bool) $phpwind['bbs']);
		include template('admin/phpwind');
	}
