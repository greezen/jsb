 ...
 * @version $Id: task.mod.php 5046 2013-11-20 07:50:10Z wuliyong $
 */
...
class ModuleObject extends MasterObject
{
	...
	function LogDelete()
	{
		...
		{
			$sql="DELETE FROM ".TABLE_PREFIX.'task_log'." where `id` IN " . jimplode($log_id_list);
			$query = $this->DatabaseHandler->Query($sql);
		}
				elseif ($day>0)
		{
	...
	function Modify()
	{
		...
		include template('admin/task_info');
	}
