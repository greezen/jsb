 ...
 *
 * @Date 2013-11-11 753688768 7638 $
 */
...
class ModuleObject extends MasterObject
{
	...
	function main()
	{
		...
		if (!empty($talk_info)) {
			...
			foreach($talk_list as $key => $val){				$talk_list[$key]['guest'] = array_slice($val['guest'],0,3,true);
			}
		...
		include template('talk/talk_index');
	}
