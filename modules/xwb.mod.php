 ...
 * @version $Id: xwb.mod.php 3773 2013-06-03 03:45:01Z yupengfei $
 */
...
class ModuleObject extends MasterObject
{
	...
	function Login() {
		...
		$keys = array();
		if(get_param('forcelogin')) {
			$keys['forcelogin'] = true;
		}
		$aurl = $this->oauth->getAuthorizeURL($this->callback_url, 'code', $keys);
    ...
    function _init() {
		if($this->Config['sina_enable'] && sina_weibo_init($this->Config)) {
			...
			$this->module_config = jconf::get('sina');
