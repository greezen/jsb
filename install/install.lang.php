 ...
 *
 * @Date 2013-11-11 1544351591 10517 $
 */
...
(
	...
	'config_unwriteable' => '安装向导无法写入配置文件, 请重新设置 ./setting/settings.php 文件的权限，修改为可读可写可修改的权限或者咨询空间商。',

	'database_errno_2003' => '无法连接数据库，请检查数据库是否启动，数据库服务器地址是否正确，或者咨询网站空间商。',
	'database_errno_1044' => '无法创建新的数据库，请检查数据库名称填写是否正确，或者咨询网站空间商。',
	'database_errno_1045' => '无法连接数据库，请检查数据库用户名或者密码是否正确，或者咨询网站空间商。',

	'dbpriv_createtable' => 'MySQL数据库没有CREATE TABLE（创建表）的权限，无法安装记事狗微博系统，请重新设置数据库用户权限或者咨询网站空间商。',
	'dbpriv_insert' => 'MySQL数据库没有INSERT（插入）数据的权限，无法安装记事狗微博系统，请重新设置数据库用户权限或者咨询网站空间商。',
	'dbpriv_select' => 'MySQL数据库没有SELECT（查询）数据的权限，无法安装记事狗微博系统，请重新设置数据库用户权限或者咨询网站空间商。',
	'dbpriv_update' => 'MySQL数据库没有UPDATE（更新）数据的权限，无法安装记事狗微博系统，请重新设置数据库用户权限或者咨询网站空间商。',
	'dbpriv_delete' => 'MySQL数据库没有DELETE（删除）数据的权限，无法安装记事狗微博系统，请重新设置数据库用户权限或者咨询网站空间商。',
	'dbpriv_droptable' => 'MySQL数据库没有DROP TABLE（删除表）的权限，无法安装记事狗微博系统，请重新设置数据库用户权限或者咨询网站空间商。',

	'path_unsupport' => '记事狗不支持在中文目录下安装，请重新指定安装目录或者咨询网站空间商',

	'php_version_406' => '您的 PHP 版本小于 4.0.6, 无法使用 记事狗微博系统，请重新安装更高版本的PHP环境（推荐5.2.x版本），或者咨询网站空间商。',
	'attach_enabled' => '允许/最大尺寸 ',
	'attach_enabled_info' => '您可以上传附件的最大尺寸: ',
	'attach_disabled' => '不允许上传附件',
	'attach_disabled_info' => '附件上传或相关操作被服务器禁止。',
	'mysql_version_323' => '您的 MySQL 版本低于 3.23，安装无法继续进行，请重新安装更高版本的MSYQL环境（推荐5.x版本），或者咨询网站空间商。',
	'mysql_unsupport' => '您的服务器不支持MySql数据库，无法安装记事狗微博系统程序，请先安装MySQL环境，或者咨询网站空间商。',
	'cache_unwriteable' => '缓存目录(./data/cache)属性非 777 或无法写入，在线缓存功能将无法使用，请设置目录为可读可写可修改权限，或者咨询网站空间商。',
	'images_unwriteable' => '图片目录(./imagess)属性非 777 或无法写入，系统将无法使用图片聚合功能，请设置目录为可读可写可修改权限，或者咨询网站空间商。',
	'log_unwriteable' => '错误日志目录(./data/log)属性非 777 或无法写入，错误日志将无法记录，请设置目录为可读可写可修改权限，或者咨询网站空间商。',
	'install_unwriteable' => '安装目录(./install)属性非 777 或无法写入，系统安装后将不能锁定，有可能多次安装，比较危险，请设置目录为可读可写可修改权限，或者咨询网站空间商。',
	'setting_unwriteable' => '配置目录(./install)属性非 777 或无法写入，无法保存系统配置文件，请设置目录为可读可写可修改权限，或者咨询网站空间商。',
	'tablepre_invalid' => '您指定的数据表前缀包含点字符(".")，请返回修改。',
	'db_invalid' => '指定的MySQL数据库不存在, 系统也无法自动建立, 无法安装记事狗微博系统，请先手工创建好数据库或者设置数据库用户创建数据库的权限或者咨询网站空间商。',
	'db_auto_created' => '指定的数据库不存在, 但系统已成功建立, 可以继续安装。',
	'db_not_null' => '数据库中已经安装过记事狗微博系统, 继续安装会清空原有数据。',
...
<p>杭州神话信息技术有限公司为 记事狗 产品的开发商，依法独立拥有 记事狗 的软件著作权。记事狗 官方网站网址为 http:/'.'/www.jishigou.net， 公司官方网址为 http:/'.'/www.cenwor.com。

<p>记事狗 的软件著作权受法律和国际公约保护，使用者无论个人或组织、盈利与否、用途如何（包括以学习和研究为目的），均需仔细阅读本协议，在理解、同意、并遵守本协议的全部条款后，方可开始使用 记事狗，杭州神话信息技术有限公司拥有对本授权协议的最终解释权。

<ul type="I">
<p><li><b>协议许可的权利</b>
<ul type="1">
    <li>您可以在完全遵守本最终用户授权协议的基础上，将本软件应用于非商业用途，而不必支付软件商业授权费用。
...
<p><li><b>协议规定的约束和限制</b>
<ul type="1">
<li>将本软件用于商业用途（包括但不限于企事业网站、经营性网站、以营利为目的或实现盈利的网站），必须按我公司网站上明示的收费标准支付费用来购买商业授权，登录http:/'.'/www.jishigou.net 了解相关说明，也可以致电0571-88800819或加企业QQ800058566了解详情。
...
<li>如果您未能遵守本协议的条款，您所被许可的权利将被收回，并承担由此给我们带来的一切经济和商业损失以及相应法律责任。
</ul>
...
我们有权随时终止授权，责令停止损害，并保留追究相关责任的权力。',
	...
	'preparation' => '<li>请给以下目录和文件可写和可修改权限：<br />&nbsp; &nbsp; <b>./data/cache</b> 目录;&nbsp; &nbsp; <b>./images</b> 目录;&nbsp; &nbsp; <b>./data/log</b> 目录;&nbsp; &nbsp;  <b>./install</b> 目录; &nbsp;&nbsp;<B>./setting </B>目录及目录下所有文件
	 &nbsp;&nbsp;</li>',

);

$msglang = array(
	'lock_exists' => '您已经安装过本系统，<br />
	如果您想重新安装，为防止误操作，您需要完成以下步骤：<br />
	1、请删除 data/install.lock 和 install/install.lock 文件，<br />
	2、通过FTP修改 setting/settings.php 文件，将 install_lock_time 值设置为0，<br />
	...
	'config_nonexistence' => '您的 ./setting/settings.default.php 或 ./setting/settings.php 不存在, 无法继续安装, 请用 FTP 将该文件上传后再试。',
