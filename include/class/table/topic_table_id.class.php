 ...
 * @version $Id: topic_table_id.class.php 3678 2013-05-24 09:48:20Z wuliyong $
 */
...
class table_topic_table_id extends table {

	
	var $table = 'topic_table_id';

	function table_topic_table_id() {
