...
$_LANG = array(
	...
	'xwb_new_is_auto2sinamblog' => '新发微博是否自动发到新浪微博',
	...
	'xwb_sina_nick' => '昵称',
	'xwb_del_bind' => '解除绑定',
	'xwb_del_bind_txt' => '解除绑定后，您发表的内容将不再同步到新浪微博',
	...
	'xwb_site_user_not_exist' => '所绑定的&nbsp;' . XWB_S_NAME . '&nbsp;用户不存在或者被管理员删除。<br />请重新用新浪微博帐号登录，或者联系网站管理员。',
	);
