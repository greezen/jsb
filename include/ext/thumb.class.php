 ...
 *
 * @Date 2014-04-25 14:36:59 909230506 922486247 24834 $
 */
...
class ThumbHandler
{
	...
	function _mkdirs($path)
	{
		...
		if(($rootdir!='.'||$rootdir!='..')&&!is_dir($rootdir))
		{
			@mkdir($rootdir, 0777);
		}
