...
/**
 * 文件名：yy.func.php
 * @version $Id: yy.func.php 4095 2013-08-08 02:09:43Z yupengfei $
 * 作者：狐狸<foxis@qq.com>
 * 功能描述: YY接口函数
 */
...
function yy_login($ico='s')
{
	...
	if (false != ($sys_config = yy_enable()))
	{
		...
		$return = '<a class="yyLogin" href="#" onclick="window.location.href=\''.$sys_config['site_url'].'/index.php?mod=yy&code=login\';return false;"><img src="'.$img_src.'"  /></a>';
	}
