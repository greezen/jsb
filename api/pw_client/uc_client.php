...
*/
function uc_user_login($username, $password, $logintype = 0, $checkques = 0, $question = '', $answer = '') {
...
//phpwind的设计缺陷，暂时不使用
function uc_avatar() {
	$uc_avatarflash = UC_API.'/js/face.swf';
	$save_param = rawurlencode(UC_API.'/job.php?action=uploadicon&step=2&');
	$icon_encode_url = 'saveFace='.$save_param.'&url=images/facebg.jpg&imgsize=20480&';
	return '<object classid="clsid:d27cdb6e-ae6d-11cf-96b8-444553540000" codebase=" http://fpdownload.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=7,0,0,0" width="560" height="450" id="FlashVars" align="middle">
		<param name="movie" value="'.$uc_avatarflash.'" />
		<param name="FlashVars" value="'.$icon_encode_url.'" />
		<embed  width="560" height="450" src="'.$uc_avatarflash.'" FlashVars="'.$icon_encode_url.'" pluginspage="http://www.macromedia.com/shockwave/download/index.cgi?P1_Prod_Version=ShockwaveFlash"  type="application/x-shockwave-flash" />
	</object>';
}
?>